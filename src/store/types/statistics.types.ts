...
import type { Nutrition } from "./ingredients.types";
...
export const respToSymptomStatistics = (
	...
	resp.statistics
		...
		.sort((a, b) => b.within72hours - a.within72hours);
...
export const respToNutritionStatistics = (
	resp: hista.NutritionStatisticsResponse,
): Array<NutritionStatistic> => {
