import type { User } from "@bbrighter/auth-module/users";

import type { Instance } from "./auth/instance";
import type {
	AddAction,
	BaseArrayStore,
	BaseRecordStore,
...
export type ConditionEventStore = {
	...
	updateConditionEvent: (
		id: number,
		part: Partial<types.ConditionEvent>,
	) => void;
...
export type IngredientStore = BaseArrayStore<
	types.Ingredient,
	"ingredients",
	"ingredient"
>;
export type StatusStore = BaseArrayStore<types.Status, "statuses", "status">;
export type ConditionEventsStore = BaseArrayStore<
	types.MetaConditionEvent,
	"metaConditionEvents",
	"metaConditionEvent"
>;
export type TemplateStore = BaseRecordStore<
	types.Template,
	"templates",
	"template"
>;

type MedicineActions = SetAction<types.Medicine, "medicines"> &
...
export type HeadacheStore = BaseRecordStore<
	types.Headache,
	"headaches",
	"headache"
