...
const symptomHandlers = (baseUrl: string) => [
	...
	http.post(`${baseUrl}/symptom-categories`, () =>
...
const conditionEventHandlers = (baseUrl: string) => [
	http.get(`${baseUrl}/condition-events`, () =>
		HttpResponse.json({
			conditionEvents: [{ id: 1, date: "2024-01-01T00:00:00Z" }],
		} satisfies hista.ConditionEventListResponse),
	),
	http.post(`${baseUrl}/condition-events`, () =>
		HttpResponse.json({ id: 2, date: "2025-01-31T12:00:00Z", conditions: [] }),
	),
	http.get(`${baseUrl}/condition-events/:id`, () =>
		HttpResponse.json({
			id: 1,
	...
	http.delete(`${baseUrl}/condition-events/:id`, () =>
	...
	http.post(`${baseUrl}/condition-events/:id/conditions`, () =>
		HttpResponse.json({
