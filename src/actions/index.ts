/** biome-ignore-all lint/suspicious/noExplicitAny: Generic helper functions need any */
...
const createActions = <
	T extends Record<string, (...args: Array<any>) => Promise<any>>,
>(
	service: T,
): T => {
	const wrappedService: any = {};
	for (const [key, fn] of Object.entries(service)) {
		wrappedService[key] = (...args: Array<any>) =>
