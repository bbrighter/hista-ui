	...
	return (
		<Box sx={{ width: "100%" }}>
			...
			<Stack spacing={3} direction="row" sx={{ alignItems: "center" }}>
				{props.iconMapping ? props.iconMapping(value) : null}
				<Slider
					marks
					value={value}
					...
					color={
						props.muiColorMapping ? props.muiColorMapping(value) : "primary"
					}
					sx={{
						"& .MuiSlider-thumb": {
							backgroundColor: props.colorMapping
								? props.colorMapping(value)
								: "primary",
						},
						"& .MuiSlider-track": {
							backgroundColor: props.colorMapping
