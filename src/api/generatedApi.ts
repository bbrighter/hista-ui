// Code generated by the Encore v1.41.14 client generator. DO NOT EDIT.
...
export namespace api {
    ...
    export class ServiceClient {
        ...
        public async CreateConditionEvent(): Promise<entity.ConditionEventResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("POST", `/condition-events`)
        ...
        public async DeleteFood(foodId: number): Promise<entity.IngredientsResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("DELETE", `/foods/${encodeURIComponent(foodId)}`)
        ...
        public async GetConditionEvents(): Promise<entity.ConditionEventsResponse> {
            // Now make the actual call to the API
        ...
        public async GetFoods(mealId: number): Promise<entity.FoodsResponse> {
            // Now make the actual call to the API
        ...
        public async GetStatisticsBySymptomIds(params: StatisticParams): Promise<entity.FoodStatisticsResponse> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
                "from_date": String(params.fromDate),
                "i_ds":      params.ids.map((v) => String(v)),
        ...
        public async GetSymptoms(): Promise<entity.SymptomCategoriesResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/symptoms`)
            return await resp.json() as entity.SymptomCategoriesResponse
        }

        public async ListStatus(): Promise<entity.StatusesResponse> {
            // Now make the actual call to the API
        ...
        public async PatchFoodCondition(foodId: number, params: FoodConditionParams): Promise<void> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
        ...
        public async PatchNote(noteId: number, params: NoteParams): Promise<void> {
        ...
        public async PostStatus(params: DateParam): Promise<entity.StatusResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("POST", `/status`, JSON.stringify(params))
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "hista-api-dpc2-Generated-TS-Client (Encore/v1.41.14)";
        }
